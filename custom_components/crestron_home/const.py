...
OPT_PREDICTIVE_STOP = "predictive_stop"
...
SHADE_POLL_INTERVAL_BURST = 0.5
SHADE_BURST_SECONDS = 3.0

BATCH_DEBOUNCE_MS = 80
BATCH_MAX_ITEMS = 16

PREDICTIVE_DEFAULT_ENABLED = True
PREDICTIVE_TAU_ACC = 1.0
PREDICTIVE_TAU_DEC = 1.0
PREDICTIVE_TAU_RESP_INIT = 0.15
PREDICTIVE_RLS_FORGETTING = 0.98
PREDICTIVE_TAU_RESP_ALPHA = 0.25
PREDICTIVE_MIN_CONFIDENCE_SCALE = 0.25
PREDICTIVE_STORAGE_VERSION = 1
PREDICTIVE_STORAGE_KEY_PREFIX = "crestron_home_predictive"
PREDICTIVE_DIAGNOSTIC_HISTORY = 5

DATA_PREDICTIVE_MANAGER = "predictive_manager"
DATA_PREDICTIVE_STORAGE = "predictive_storage"
